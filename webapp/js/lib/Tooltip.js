...
export default class Tooltip{
  ...
  constructor(plotObj,selectedEl){
    ...
    let xFormat = plotObj.options.tooltipTextXFormat;
    let yFormat = plotObj.options.tooltipTextYFormat;
    
    let xDate = new Date(_this.xVal);
    _this.xVal = xFormat == "time" ? 
        xDate.toLocaleTimeString() + " on " + xDate.toLocaleDateString() : 
        _this.xVal;
    _this.yVal = _this.yVal; 
    _this.text = [
